...
game-ticker-player-join-game-message = Welcome to Death's Sandbox! If this is your first time playing, be sure to read the game rules and ask for help in LOOC (local OOC) or OOC.
