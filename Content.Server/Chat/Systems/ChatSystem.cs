...
public enum EntityChatLanguage : byte
{
    LinguaFranca,
    Familiar,
    Animal,
...
public class EntityChat
{
    ...
    public HashSet<EntityUid> Recipients;
...
{
    public EntityChatLanguage Language;
    public RadioChannelPrototype? RadioChannel;

    public EntityChatSpokenData(EntityChatLanguage language, RadioChannelPrototype? radioChannel = null)
    {
        Language = language;
...
public sealed class GotEntityChatEvent
{
    ...
    public GotEntityChatEvent(EntityUid receiver, EntityChat chat)
    {
        Receiver = receiver;
        Chat = chat;
    }
